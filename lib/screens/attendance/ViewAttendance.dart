...
class ViewAttendanceScreen extends HookConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> fetchAttendanceRecords() async {
      try {
        attendanceRecords.value = await attendanceController.getAttendanceByDateRange(startDate.value, endDate.value);
      } catch (e) {
        // Handle the error
        print(e);
      } finally {
